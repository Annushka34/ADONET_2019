...
namespace _08_OneToMany {
    ...
    public partial class ShopDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, int Price, int CategoryId) {
...
namespace _08_OneToMany.ShopDataSet1TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([Id] = @Original_Id) AND ([Price] = @Origina" +
                "l_Price) AND ([CategoryId] = @Original_CategoryId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductName], [Price], [CategoryId]) VALUES (@Prod" +
                "uctName, @Price, @CategoryId);\r\nSELECT Id, ProductName, Price, CategoryId FROM P" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [Price] = @Price, [CategoryId] = @CategoryId WHERE (([Id] = @Original_Id) AND ([Price] = @Original_Price) AND ([CategoryId] = @Original_CategoryId));
SELECT Id, ProductName, Price, CategoryId FROM Products WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-LNTJUIU;Initial Catalog=Shop;Integrated Security=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ProductName, Price, CategoryId FROM dbo.Products";
        ...
        public virtual int Fill(ShopDataSet1.ProductsDataTable dataTable) {
        ...
        public virtual ShopDataSet1.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ShopDataSet1.ProductsDataTable dataTable = new ShopDataSet1.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ShopDataSet1.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, int Original_Price, int Original_CategoryId) {
        ...
        public virtual int Insert(string ProductName, int Price, int CategoryId) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(string ProductName, int Price, int CategoryId, int Original_Id, int Original_Price, int Original_CategoryId, int Id) {
            if ((ProductName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, int Price, int CategoryId, int Original_Id, int Original_Price, int Original_CategoryId) {
            return this.Update(ProductName, Price, CategoryId, Original_Id, Original_Price, Original_CategoryId, Original_Id);
        }
    }
